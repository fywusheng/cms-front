...
export default function(url, params = ''){
    if(!url) return ''
    url = url.replace('https://xiu-obs.obs.cn-south-1.myhuaweicloud.com', 'http://img.cms.xiu.com');
    url = url.replace('https://sku-images.obs.cn-south-1.myhuaweicloud.com', 'http://img.sku.xiu.com')

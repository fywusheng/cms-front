...
import TopicCom  from 'root/components'

import 'reset.css'
import 'root/config/axios'
import 'root/app/assets/lib/flexible'
import 'root/app/assets/style/common'
 ...
 * 注册后台组件
 */
Vue.component('backend', () => import(/* webpackChunkName: "backend" */ 'root/backend'))
Vue.component('masker', () => import(/* webpackChunkName: "backend-masker" */ 'root/backend/masker'))
